...
const AnimatedLink = ({
  ...
  return (
    <a
      // Color is inherited (currentColor) so the link adapts to whatever surface
      // it sits on — white over the hero, --ink on light surfaces — and the
      // underline/arrow (bg-current / currentColor) match automatically.
      className={cn(
