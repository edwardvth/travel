...
// The globe box is short (its golden content sits up top); it stays solid through
// the video handoff (~100vh) then dissolves into the starfield, which fills the
// rest of the page beneath it.
const GLOBE_MASK = 'linear-gradient(to bottom, #000 67%, transparent 92%)'
...
export function CockpitHome({
  ...
  return (
    <div className="relative min-h-[100svh] bg-[#05060a] text-white">
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-0 h-[150vh] overflow-hidden"
