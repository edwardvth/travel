...
export const HERO_CONFIG: HeroVideoConfig = {
  ...
  clips: [
    ...
    },
    {
      ...
      timeOfDay: ['evening'],
      season: ['summer'],
      poster: poster('1533105079780-92b9be482077'),
      sources: sources('amalfi-sunset'),
      dominantColor: '#d6845f',
      focalPoint: { x: 0.5, y: 0.5 },
      credit: { author: 'Unsplash', source: 'Custom', url: 'https://unsplash.com/photos/1533105079780-92b9be482077', license: 'Unsplash' },
      weight: 1,
    },
    {
      id: 'tokyo-neon',
